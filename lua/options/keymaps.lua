...
-- Plugins
-- Sniprun
keymap('n', 'sr', '<Plug>SnipRun')
keymap('n', 'sc', '<Plug>SnipClose')
keymap('n', 'sro', '<Plug>SnipRunOperator')
--Treesitter
...
keymap('n', 'tw', '<CMD>TroubleToggle workspace_diagnostics<CR>')
keymap('n', 'td', '<CMD>TroubleToggle document_diagnostics<CR>')
-- Tss
keymap('n', 'tsj', '<CMD>TSJJoin<CR>')
keymap('n', 'tss', '<CMD>TSJSplit<CR>')
keymap('n', 'tst', '<CMD>TSJToggle<CR>')
-- Zen Mode
